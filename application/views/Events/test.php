...
<style>
    ...
    .image-item img {
        grid-column: 1 / span2;
        width: 100%;
        /* ทำให้รูปเต็มความกว้างของ .grid-item */
        height: auto;
        /* ให้รูปยืดเต็มความสูงของ .grid-item */
        object-fit: cover;
        /* ให้รูปครอบคลุมพื้นที่ทั้งหมดโดยรักษาสัดส่วน */
        border-radius: 8px;
        /* เพิ่มมุมโค้งให้กับรูป */
        ...
        <div class="container-cs mb-3 ">
            <div class="grid-container">
                ...
                <div class="image-item img ">
                    ...
                    <img src="<?php echo base_url('assets/images/cat.png') ?>">
                </div>

                <div class="border-bottom1" style="background-color:#ffffff" >
                    <div class="container">
                        <div class="row ">
