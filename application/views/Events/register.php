...
<body style="background-color:#F9F9F9">
    ...
    <div class="row lg-margin-t-reg ">
        ...
        <div class="col-md-auto col-auto text-center">
            ...
            <a href="<?php echo base_url('Events/info'); ?>" class="font-24-black mt-4 ml-3 ">
                < ย้อนกลับ </a>
        </div>
    </div>
    ...
    <div class="container-reg mb-5">
        ...
        <div class="row ma-lr-reg ">
            <div class="col-12">
                <form id="registrationForm" action="finish" method="post">
                    ...
                    <div class="row ma-lr-reg mt-5">
                        ...
                        <div class="col-12 text-center mb-4">
                            <button class="box-reg" onclick="return validateForm()">
